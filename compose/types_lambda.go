...
// InvokeWOSOpt is the type of the invokable lambda function without options and state.
type InvokeWOSOpt[I, O, S any] func(ctx context.Context, input I, lock *sync.Mutex, state *S) (output O, err error)
...
func InvokableLambdaWithState[I, O, S any](i InvokeWOSOpt[I, O, S], opts ...LambdaOpt) *Lambda {
	f := func(ctx context.Context, input I, opts_ ...unreachableOption) (output O, err error) {
